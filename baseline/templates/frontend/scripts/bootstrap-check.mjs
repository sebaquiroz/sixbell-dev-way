...
console.log(
  isBootstrapped
    ? 'Bootstrap verification passed. The frontend template is OpenSpec-ready and generated Kiro/GitHub Copilot assets are present.'
    : 'Bootstrap check passed. The frontend template source structure is present.'
);