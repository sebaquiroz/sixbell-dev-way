...
const templatePaths = [
  ...
  'openspec/specs/backend-layout/spec.md',
...
console.log(
  isBootstrapped
    ? 'Bootstrap verification passed. The backend template is OpenSpec-ready and generated Kiro/GitHub Copilot assets are present.'
    : 'Bootstrap check passed. The backend template source structure is present.'
);